...
with st.expander('이 앱에 대하여'):
    st.write('`st.experimental_et_query_parmas`는 사용자 브라우저의 URL 에서 직접 쿼리 매개변수를 검색할 수 있게  해줍니다.')
...
# 2. st.experimental_get_query_params 의 내용
st.header('2. st.experimental_get_query_params 의 내용')
st.write(st.experimental_get_query_params())

# 3. URL 에서 정보 검색 및 표시
st.header('3. URL 에서 정보 검색 및 표시')
